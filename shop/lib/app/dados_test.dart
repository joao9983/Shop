  ...
  Categoria(
    ...
    produtos: [
      ...
      Produto(
        quantidade: 1,
        nome: "banana",
        id: "124961cc-2a48-11ee-be56-0242ac120002",
        preco: 07.25,
        image:
...
List<Compras> compras = [
  ...
  Compras(codigo: "HiMf4MWV", data: "05/10/2022", valor: 2.50, produtos: [
    Produto(
      peso: 0.4,
      nome: "goiaba",
      id: "adf7fe80-8e71-4183-a232-620765ee9954",
  ...
  Compras(codigo: "YGwo3qJV", data: "30/09/2022", valor: 31.00, produtos: [
    Produto(
      peso: 1.0,
      nome: "goiaba",
      id: "adf7fe80-8e71-4183-a232-620765ee9954",
